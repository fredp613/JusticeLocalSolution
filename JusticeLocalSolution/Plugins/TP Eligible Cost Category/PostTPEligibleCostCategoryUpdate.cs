// <copyright file="PostTPEligibleCostCategoryUpdate.cs" company="Department of Justice/ministaire de la Justice">
// Copyright (c) 2016 All Rights Reserved
// </copyright>
// <author>Department of Justice/ministaire de la Justice</author>
// <date>7/15/2016 3:11:13 PM</date>
// <summary>Implements the PostTPEligibleCostCategoryUpdate Plugin.</summary>
// <auto-generated>
...
namespace JusticeLocalSolution.Plugins
{
    ...
    /// </summary>    
    public class PostTPEligibleCostCategoryUpdate : IPlugin
    {
                ...
                context.InputParameters["Target"] is Entity)
            {
                ...
                if (entity.GetAttributeValue<EntityReference>("egcs_tp_profile") != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            throw new InvalidPluginExecutionException("something went wrong in the TP Eligible Cost Category post update plugin", ex1);
                        }
