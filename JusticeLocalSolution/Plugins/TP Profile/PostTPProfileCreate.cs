// <copyright file="PostTPProfileCreate.cs" company="Department of Justice/ministaire de la Justice">
// Copyright (c) 2016 All Rights Reserved
// </copyright>
// <author>Department of Justice/ministaire de la Justice</author>
// <date>6/27/2016 11:27:28 AM</date>
// <summary>Implements the PostTPProfileCreate Plugin.</summary>
// <auto-generated>
...
namespace JusticeLocalSolution.Plugins
{
    ...
    /// </summary>    
    public class PostTPProfileCreate: IPlugin
    {
                ...
                context.InputParameters["Target"] is Entity)
            {
                ...
                if (entity.Attributes.Contains("egcs_amtannualplannedbudget") && entity.Attributes.Contains("egcs_datestart") && entity.Attributes.Contains("egcs_dateend"))
                {
                    try
                    {
                        ...
                        Money amt = entity.GetAttributeValue<Money>("egcs_amtannualplannedbudget");
                        ...
                        {                            
                            throw new InvalidPluginExecutionException("An error3 occurred in the TP Profile Create plug-in. Contact administrator", ex1);
                        };
                    }
